...
const DOC_DESCRIPTIONS: Record<string, string> = {
  ...
  terms: "Terms of Service for the VYBZ platform, API, MCP server, and console, provided by Astra Matrix, Inc. Accounts, plans and billing, content, and liability.",
  privacy: "How Astra Matrix, Inc. handles personal data on vybz.cloud and the VYBZ API: what is collected, where it lives, retention, your rights, and security.",
