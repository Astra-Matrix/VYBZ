...
export const PLANS: Plan[] = [
  {
    ...
    price: null,
    trialDays: 0,
    tagline: "Evaluate the API and the agent tools.",
    features: ["1 member, 3 keys", "100 issuances / month", "20 detections / month", "2 GB Vault", "Hosted and local MCP", "Community support"],
  ...
  },
  {
    ...
    trialDays: 14,
    tagline: "One person, every project versioned and every copy attributable.",
    features: ["100 GB Vault", "200 issuances / month", "50 detections / month", "Content Credentials", "Email support"],
  ...
  },
  {
    ...
    trialDays: 14,
    tagline: "Producers, small labels, and studios.",
    features: ["500 GB Vault, then $0.015 / GB", "1,500 issuances / month, then $0.02", "300 detections / month, then $0.10", "5 members", "Content Credentials", "Webhooks, audit export"],
  ...
  },
  {
    ...
    trialDays: 14,
    tagline: "Catalogs, sync houses, and distributors.",
