...
| `PADDLE_PRICE_BUSINESS` | Supabase Edge (env) | Legacy; unused since the plan ladder. Prices now live in `_shared/plans.ts` per environment (Creator, Pro, Ultimate, monthly and yearly, each with a 14-day trial). Old Business price used by the console's Upgrade button before that. Yearly: live `pri_01m1ysawsyk0n263k6ktrhbfbq`, sandbox `pri_01m1yrnhtqh0q9q60e23zvvbz7`. Live: `pri_01m1yqesgyjw5ysj92svmhxn3v` on product `pro_01m1yqes0gs9m80gxehk1gkhxk`. Sandbox: `pri_01m1ybdqphgqerhccne3my186b` on product `pro_01m1ybdqa5gvs29syp4bayhr6g`. |
